...
export default function HotelEditAdmin({ propHotel }) {
    ...
    const handelerUpdate = async () => {
        ...
        console.log('activeAmenitiesBtn', activeAmenitiesBtn)
    ...
    // ==================== END ======================== //
    return (
        <div className='hotel--edit--admin--container'>
            ...
            <div className='mid--box'>
                ...
                {locations.map((loc, index) => (
                    <div className='tourist--attraction--box'>
                        <input
                            key={index}
                            type="text"
                            value={loc}
