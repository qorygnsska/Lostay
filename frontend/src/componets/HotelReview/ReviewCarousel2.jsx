...
export default function ReviewCarousel2({ images, handleImageSelect, isModal, propIndex }) {
    ...
    return (
        <div className="review--carousel2--container">
            {totalSlides >= slideShowCtn ? (
                <>
                    {/* 슬라이드 실행 */}
                    <Slider ref={sliderRef} {...settings}>
                        {images.map((image, index) => (
                            <div className="image--box" onClick={() => handleImageSelect(index,images)}  key={index}>
